...
$query = "SELECT a.*, b.plate_number, b.brand, b.model, b.type FROM trx a 
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <?php else : ?>
                        <li class="nav-item">
                            <a class="nav-link" href="./listKendaraan.php">Kendaraan</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="./transaksiUser.php">Transaksi</a>
                        </li>
                    <?php endif; ?>
                </ul>
    ...
    <div class="container my-2">
        <h5 class="fw-bold text-center mb-3">Daftar Transaksi Kamu</h5>
        <table class="table">
